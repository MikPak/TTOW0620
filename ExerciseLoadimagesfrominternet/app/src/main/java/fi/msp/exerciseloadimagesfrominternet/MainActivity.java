package fi.msp.exerciseloadimagesfrominternet;
...
public class MainActivity extends AppCompatActivity {
    ...
    private final String PATH = "https://mikkopakkanen.com/img/random/";
    // example image names (change to your own if needed...)
    private String[] images = {"kauppinen.jpg","nalle.jpg","spurdo.png"};
